...
public class PlayScreen implements Screen {
    ...
    public void show() {
        ...
        Square rotating_square = new Square(world, "SQUARE", viewport.getWorldWidth() / 2,
                (float) (viewport.getWorldHeight() * 0.6), 32, 32);
...
//        b2ddr =  new Box2DDebugRenderer();
    ...
    private BulletCharacter makeBullet() {
        TextureRegion bulletRegion = new TextureRegion(new Texture( Gdx.files.internal("colour_shooter/bullet.png")));
...
//        yellow.update();
        ...
        if (Gdx.input.isTouched() & !bullet_in_motion) {
            ...
            BulletCharacter bullet = makeBullet();
