...
public class StateFactory {
  ...
  public static Screen getScreen(
    ...
    if (type.equalsIgnoreCase("play screen")) return new PlayScreenRetro(mainscreen);
    ...
    else if (type.equalsIgnoreCase("instructions screen"))
      return new InstructionsScreen(game, mainscreen);
    else return null;
  }
}
