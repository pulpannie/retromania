...
public class TicTacToe {
   ...
   *
   * @param userPreference Current user's TicTacToe game's preference instantiates CellManager
   *     class.
   */
  @Inject
  ...
  public boolean isEnd() {
    return (cellManager.checkRow()
        || cellManager.checkColumn()
        || cellManager.checkDiagLeft()
        || cellManager.checkDiagRight()
        || cellManager.allTouched());
  }
