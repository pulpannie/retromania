package com.retromania.game.mario.views.mission;
...
public abstract class MissionView extends RetroManiaScreen
    implements DeathObserver, FinisherObserver {
  private UserRenderPreference userRenderPreference;
  private MarioGamePresentable marioGamePresentable;

  public MissionView(
      MarioGamePresenter marioGamePresenter, UserRenderPreference userRenderPreference) {
